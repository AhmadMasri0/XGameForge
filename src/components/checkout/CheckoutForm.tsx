...
const CheckoutForm = () => {
    ...
    const validateFields = (): string | null => {
        const requiredFields: Array<keyof FormData> = ['fullName', 'email', 'phone', 'address', 'city', 'zip'];
    ...
    return (
        <Paper sx={{ p: 3 }}>
            ...
            <form onSubmit={handleSubmit} noValidate>
                {(['fullName', 'email', 'phone', 'address', 'city', 'zip'] as Array<keyof FormData>).map(field => (
                    <TextField
                        key={field}
                        name={field}
                ...
                <FormControl component="fieldset" margin="normal">
                    ...
                    <RadioGroup
                        ...
                        onChange={(e: ChangeEvent<HTMLInputElement>) => setSelectedMethod(e.target.value as PaymentMethod)}
                    >
