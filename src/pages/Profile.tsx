...
import EditProfile from '../components/profile/EdttProfile';
            ...
            <Paper sx={{ p: 3 }}>
                ...
                >
                    <Tab 
                        ...
                        sx={{ 
                            color: tab === 0 
                                ? `${theme.customColors.activeTab} !important` 
                                : theme.customColors.inactiveTab 
                        }} 
                    />
                    <Tab 
